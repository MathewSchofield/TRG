...
\begin{figure}
	\centering
	\includegraphics[scale=0.6]{Plot3_Imag_tested_distribution}
	\caption{.}	
	\label{fig:imag test}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.6]{Plot3_Imag_trained_distribution}
	\caption{.}	
	\label{fig:imag train}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[scale=0.6]{Plot3_Kp_distribution}
