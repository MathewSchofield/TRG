...
% red clump stars all have very similar core masses. secondary clump stars lie in the same teff/lum space but have different core masses. 2CL stars are slightly too massive ($\geq$ 1.8 \msol) to undergo helium flash. If a star is large enough, it will undergo the helium flash and become a RC star.
